...
export declare type AircraftTypeResponse = AircraftType | AircraftType[] | null;
...
export declare type GetAircraftTypes = (aircraftTypeId: string, apiKey: string) => Promise<AircraftTypeResponse>;
...
export declare type GetAircraftAtAirport = (icao: string, apiKey: string) => Promise<AircraftResponse>;
