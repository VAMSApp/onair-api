...
exports.getCompanyCashFlow = void 0;
1;
var onAirRequest_1 = __importDefault(require("./onAirRequest"));
var utils_1 = require("../utils");
var endPoint = 'company/';
var getCompanyCashFlow = function (companyId, apiKey) { return __awaiter(void 0, void 0, void 0, function () {
    var response, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, (0, onAirRequest_1.default)("https://server1.onair.company/api/v1/".concat(endPoint).concat(companyId, "/cashflow"), apiKey)];
            case 2:
                response = _a.sent();
...
exports.getCompanyCashFlow = getCompanyCashFlow;
