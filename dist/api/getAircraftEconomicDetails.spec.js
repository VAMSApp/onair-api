...
var getAircraftEconomicDetails_1 = require("./getAircraftEconomicDetails");
...
(0, mocha_1.describe)('getAircraftEconomicDetails', function () {
    it('should be a function', function () {
        (0, chai_1.expect)(typeof getAircraftEconomicDetails_1.getAircraftEconomicDetails).to.equal('function');
    });
    it('should return an object of costs for the given AircraftId', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, getAircraftEconomicDetails_1.getAircraftEconomicDetails)(AircraftId, ApiKey)];
                case 1:
                    x = _a.sent();
                    if (!x || x === null)
    ...
    it('should throw an error if the provided aircraftId is invalid', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, getAircraftEconomicDetails_1.getAircraftEconomicDetails)('invalidAircraftId', ApiKey)];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
    ...
    it('should throw an error if the provided apiKey is invalid', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, getAircraftEconomicDetails_1.getAircraftEconomicDetails)(AircraftId, 'invalidApiKey')];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
