...
(0, mocha_1.describe)('getCompanyJobs', function () {
    it('should be a function', function () {
        (0, chai_1.expect)(typeof getCompanyJobs_1.getCompanyJobs).to.equal('function');
    });
    it('should return an array of pending Jobs for the given companyId', function () { return __awaiter(void 0, void 0, void 0, function () {
        var jobs;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, getCompanyJobs_1.getCompanyJobs)(CompanyId, ApiKey)];
                case 1:
                    jobs = _a.sent();
                    ...
                    if (jobs.length > 0) {
                        ...
                        (0, chai_1.expect)(jobs[0].Id).to.equal('fe2f795f-36bd-4718-bfa0-4c01ae0a3fdb');
                    }
                    return [2 /*return*/];
            }
        });
    }); });
    it('should return an array of completed Jobs for the given companyId', function () { return __awaiter(void 0, void 0, void 0, function () {
        var jobs;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, getCompanyJobs_1.getCompanyJobs)(CompanyId, ApiKey, true)];
                case 1:
                    jobs = _a.sent();
                    (0, chai_1.expect)(jobs).to.be.an('array');
                    if (jobs.length > 0) {
    ...
    it('should throw an error if the provided Company ID is invalid', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, getCompanyJobs_1.getCompanyJobs)('invalidCompanyId', ApiKey)];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
    ...
    it('should throw an error if the provided API Key is invalid', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, getCompanyJobs_1.getCompanyJobs)(CompanyId, 'invalidApiKey')];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
