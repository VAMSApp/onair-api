...
function subtractDays(dateStr, days) {
    if (dateStr === void 0) { dateStr = new Date().toISOString(); }
...
var getCompanyIncomeStatement = function (companyId, apiKey, startDate, endDate) { return __awaiter(void 0, void 0, void 0, function () {
    var currentDate, currentDateStr, StartDateStr, EndDateStr, url, oaResponse, response, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                EndDateStr = endDate;
                url = "https://server1.onair.company/api/v1/".concat(endPoint).concat(companyId, "/incomestatement?startDate=").concat(StartDateStr, "&endDate=").concat(EndDateStr);
                return [4 /*yield*/, (0, onAirRequest_1.default)(url, apiKey)];
            case 2:
                oaResponse = _a.sent();
                if (typeof oaResponse.data.Content === 'undefined') {
                    throw new Error(oaResponse.data.Error ? oaResponse.data.Error : "Company Id \"".concat(companyId, "\"\" not found"));
                }
                response = {
            ...
            case 3:
                e_1 = _a.sent();
                throw new Error(e_1.oaResponse.status === 400 ? "Company Id \"".concat(companyId, "\"\" not found") : e_1.message);
