...
(0, mocha_1.describe)('getCompanyFlights', function () {
    it('should be a function', function () {
        (0, chai_1.expect)(typeof getCompanyFlights_1.getCompanyFlights).to.equal('function');
    });
    it('should return an array of Flights for the given companyId', function () { return __awaiter(void 0, void 0, void 0, function () {
        var flights;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, getCompanyFlights_1.getCompanyFlights)(CompanyId, ApiKey)];
                case 1:
                    flights = _a.sent();
                    (0, chai_1.expect)(flights).to.be.an('array');
                    if (flights.length > 0) {
                        (0, chai_1.expect)(flights[0]).to.have.any.keys([
                            'Id',
                            'AircraftAddonId',
                            'AircraftId',
                            'CompanyId',
    ...
    it('should throw an error if the provided Company ID is invalid', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, getCompanyFlights_1.getCompanyFlights)('invalidCompanyId', ApiKey)];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
    ...
    it('should throw an error if the provided API Key is invalid', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, getCompanyFlights_1.getCompanyFlights)(CompanyId, 'invalidApiKey')];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
