...
(0, mocha_1.describe)('getVirtualAirlineShareHolders', function () {
    it('should be a function', function () {
        (0, chai_1.expect)(typeof getVirtualAirlineShareHolders_1.getVirtualAirlineShareHolders).to.equal('function');
    });
    it('should return an array of the shareholder\'s for the given vaId', function () { return __awaiter(void 0, void 0, void 0, function () {
        var x;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, getVirtualAirlineShareHolders_1.getVirtualAirlineShareHolders)(VaId, ApiKey)];
                case 1:
                    x = _a.sent();
    ...
    it('should throw an error if the provided VA ID is invalid', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, getVirtualAirlineShareHolders_1.getVirtualAirlineShareHolders)('invalidVaId', ApiKey)];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
    ...
    it('should throw an error if the provided API Key is invalid', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, getVirtualAirlineShareHolders_1.getVirtualAirlineShareHolders)(VaId, 'invalidApiKey')];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
