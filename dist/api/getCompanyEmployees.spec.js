...
(0, mocha_1.describe)('getCompanyEmployees', function () {
    it('should be a function', function () {
        (0, chai_1.expect)(typeof getCompanyEmployees_1.getCompanyEmployees).to.equal('function');
    });
    it('should return an array of Employees for the given companyId', function () { return __awaiter(void 0, void 0, void 0, function () {
        var Employees;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, getCompanyEmployees_1.getCompanyEmployees)(CompanyId, ApiKey)];
                case 1:
                    Employees = _a.sent();
                    (0, chai_1.expect)(Employees).to.be.an('array');
                    (0, chai_1.expect)(Employees[0]).to.have.any.keys([
                        'Id',
                        'Pseudo',
                    ]);
                    return [2 /*return*/];
    ...
    it('should throw an error if the provided Company ID is invalid', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, getCompanyEmployees_1.getCompanyEmployees)('invalidCompanyId', ApiKey)];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
    ...
    it('should throw an error if the provided API Key is invalid', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, getCompanyEmployees_1.getCompanyEmployees)(CompanyId, 'invalidApiKey')];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
