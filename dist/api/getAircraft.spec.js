...
(0, mocha_1.describe)('getAircraft', function () {
    it('should be a function', function () {
        (0, chai_1.expect)(typeof getAircraft_1.getAircraft).to.equal('function');
    });
    it('should return a matching aircraft for the given AircraftId', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, getAircraft_1.getAircraft)(AircraftId, ApiKey)];
                case 1:
                    aircraft = _a.sent();
                    if (!aircraft || aircraft === null)
                        throw new Error('No aircraft returned');
                    (0, chai_1.expect)(aircraft).to.be.an('object');
                    (0, chai_1.expect)(aircraft.Id).to.be.a('string');
    ...
    it('should throw an error if the provided aircraftId is invalid', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, getAircraft_1.getAircraft)('invalidAircraftId', ApiKey)];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
    ...
    it('should throw an error if the provided apiKey is invalid', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, getAircraft_1.getAircraft)(AircraftId, 'invalidApiKey')];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
