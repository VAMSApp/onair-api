...
(0, mocha_1.describe)('getCompanyWorkOrders', function () {
    it('should be a function', function () {
        (0, chai_1.expect)(typeof getCompanyWorkOrders_1.getCompanyWorkOrders).to.equal('function');
    });
    it('should return an array of WorkOrders for the given companyId', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, getCompanyWorkOrders_1.getCompanyWorkOrders)(CompanyId, ApiKey)];
                case 1:
                    workOrders = _a.sent();
    ...
    it('should throw an error if the provided Company ID is invalid', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, getCompanyWorkOrders_1.getCompanyWorkOrders)('invalidCompanyId', ApiKey)];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
    ...
    it('should throw an error if the provided API Key is invalid', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, getCompanyWorkOrders_1.getCompanyWorkOrders)(CompanyId, 'invalidApiKey')];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
