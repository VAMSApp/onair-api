...
var getAircraftType_1 = require("./getAircraftType");
...
(0, mocha_1.describe)('getAircraftType', function () {
    it('should be a function', function () {
        (0, chai_1.expect)(typeof getAircraftType_1.getAircraftType).to.equal('function');
    });
    it('should return a matching aircraft for the given AircraftId', function () { return __awaiter(void 0, void 0, void 0, function () {
        var x;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, getAircraftType_1.getAircraftType)(AircraftTypeId, ApiKey)];
                case 1:
                    x = _a.sent();
                    if (!x || x === null)
                        throw new Error('No aircraft type returned');
                    (0, chai_1.expect)(x).to.be.an('object');
                    (0, chai_1.expect)(x.Id).to.be.a('string');
                    return [2 /*return*/];
            }
        });
    }); });
    it('should throw an error if the provided aircraftId is invalid', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, getAircraftType_1.getAircraftType)('invalidAircraftId', ApiKey)];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
    ...
    it('should throw an error if the provided apiKey is invalid', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, getAircraftType_1.getAircraftType)(AircraftTypeId, 'invalidApiKey')];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
