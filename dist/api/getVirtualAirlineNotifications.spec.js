...
(0, mocha_1.describe)('getVirtualAirlineNotifications', function () {
    it('should be a function', function () {
        (0, chai_1.expect)(typeof getVirtualAirlineNotifications_1.getVirtualAirlineNotifications).to.equal('function');
    });
    it('should return an array of the notification\'s for the given vaId', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, getVirtualAirlineNotifications_1.getVirtualAirlineNotifications)(VaId, ApiKey)];
                case 1:
                    x = _a.sent();
    ...
    it('should throw an error if the provided VA ID is invalid', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, getVirtualAirlineNotifications_1.getVirtualAirlineNotifications)('invalidVaId', ApiKey)];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
    ...
    it('should throw an error if the provided API Key is invalid', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, getVirtualAirlineNotifications_1.getVirtualAirlineNotifications)(VaId, 'invalidApiKey')];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
