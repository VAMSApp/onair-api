...
(0, mocha_1.describe)('getCompanyFleet', function () {
    it('should be a function', function () {
        (0, chai_1.expect)(typeof getCompanyFleet_1.getCompanyFleet).to.equal('function');
    });
    it('should return an array of Aircraft for the given companyId', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fleet;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, getCompanyFleet_1.getCompanyFleet)(CompanyId, ApiKey)];
                case 1:
                    fleet = _a.sent();
                    (0, chai_1.expect)(fleet).to.be.an('array');
                    if (fleet.length > 0) {
                        (0, chai_1.expect)(fleet[0]).to.have.any.keys([
                            'Id',
                            'AircraftTypeId',
                            'WorldId',
                        ]);
    ...
    it('should throw an error if the provided Company ID is invalid', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, getCompanyFleet_1.getCompanyFleet)('invalidCompanyId', ApiKey)];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
    ...
    it('should throw an error if the provided API Key is invalid', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, getCompanyFleet_1.getCompanyFleet)(CompanyId, 'invalidApiKey')];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
