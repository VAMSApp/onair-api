...
(0, mocha_1.describe)('getAircraftFlights', function () {
    it('should be a function', function () {
        (0, chai_1.expect)(typeof getAircraftFlights_1.getAircraftFlights).to.equal('function');
    });
    it('should return an array of flights for the given aircraftId', function () { return __awaiter(void 0, void 0, void 0, function () {
        var flights;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, getAircraftFlights_1.getAircraftFlights)(AircraftId, ApiKey)];
                case 1:
                    flights = _a.sent();
                    if (!flights || flights === null)
                        throw new Error('No flights returned');
                    (0, chai_1.expect)(flights).to.be.an('array');
                    (0, chai_1.expect)(flights[0]).to.be.an('object');
                    return [2 /*return*/];
            }
        });
    }); });
    it('should throw an error if the provided aircraftId is invalid', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, getAircraftFlights_1.getAircraftFlights)('invalidAircraftId', ApiKey)];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
    ...
    it('should throw an error if the provided apiKey is invalid', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, getAircraftFlights_1.getAircraftFlights)(AircraftId, 'invalidApiKey')];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
