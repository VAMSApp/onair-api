...
(0, mocha_1.describe)('getVirtualAirline', function () {
    it('should be a function', function () {
        (0, chai_1.expect)(typeof getVirtualAirline_1.getVirtualAirline).to.equal('function');
    });
    it('should return an object containing the details for the given vaId', function () { return __awaiter(void 0, void 0, void 0, function () {
        var va;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, getVirtualAirline_1.getVirtualAirline)(VaId, ApiKey)];
                case 1:
                    va = _a.sent();
                    (0, chai_1.expect)(va).to.be.an('object');
                    (0, chai_1.expect)(va).to.have.any.keys([
                        'InitalOwnerEquity',
    ...
    it('should throw an error if the provided VA ID is invalid', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, getVirtualAirline_1.getVirtualAirline)('invalidVaId', ApiKey)];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
    ...
    it('should throw an error if the provided API Key is invalid', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, getVirtualAirline_1.getVirtualAirline)(VaId, 'invalidApiKey')];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
