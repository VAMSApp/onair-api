...
(0, mocha_1.describe)('getCompanyCashFlow', function () {
    it('should be a function', function () {
        (0, chai_1.expect)(typeof getCompanyCashFlow_1.getCompanyCashFlow).to.equal('function');
    });
    it('should return a matching CashFlow for the given companyId', function () { return __awaiter(void 0, void 0, void 0, function () {
        var CashFlow;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, getCompanyCashFlow_1.getCompanyCashFlow)(CompanyId, ApiKey)];
                case 1:
                    CashFlow = _a.sent();
                    if (!CashFlow || CashFlow === null)
                        throw new Error('No CashFlow returned');
                    (0, chai_1.expect)(CashFlow).to.be.an('object');
                    (0, chai_1.expect)(CashFlow).to.have.any.keys([
                        'Entries',
                        'CompanyCurrentCash',
                        'LastReportAmount',
                        'LastReportDate',
    ...
    it('should throw an error if the provided Company ID is invalid', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, getCompanyCashFlow_1.getCompanyCashFlow)('invalidCompanyId', ApiKey)];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
    ...
    it('should throw an error if the provided API Key is invalid', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, getCompanyCashFlow_1.getCompanyCashFlow)(CompanyId, 'invalidApiKey')];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
