...
var getCompanyFleet = function (companyId, apiKey, world) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, onAirRequest_1.default)("https://".concat(world).concat(config_1.config.apiUrl).concat(endPoint).concat(companyId, "/fleet"), apiKey)];
            case 1:
                response = _a.sent();
...
//# sourceMappingURL=getCompanyFleet.js.map