...
var OnAirApi = /** @class */ (function () {
    ...
    OnAirApi.prototype.getCompanyFbos = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, index_1.default.getCompanyFbos(this.companyId, this.apiKey, this.world)];
                    case 1:
                        companyFbos = _a.sent();
    ...
    OnAirApi.prototype.getCompanyFlights = function (page, limit) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, index_1.default.getCompanyFlights(this.companyId, this.apiKey, this.world, page, limit)];
                    case 1:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, index_1.default.getAircraft(aircraftId, this.apiKey, this.world)];
                    case 1:
                        aircraft = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!aircraftId)
                            throw new Error('Aircraft ID not provided');
                        return [4 /*yield*/, index_1.default.getAircraftFlights(aircraftId, this.apiKey, this.world)];
                    case 1:
                        flights = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, index_1.default.getAirport(airportCode, this.apiKey, this.world)];
                    case 1:
                        airport = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, index_1.default.getFlight(flightId, this.apiKey, this.world)];
                    case 1:
                        flight = _a.sent();
